...
class Test(unittest.TestCase):
    ...
    def test_residuesFocussed(self):
        l = 160
        var_by_res = [
            TheseusVariances(idx=i, resName='', resSeq=i, variance=float(i + 1), stdDev=None, rmsd=None, core=None)
            for i in range(l)
        ]
    ...
    def test_residuesPercent(self):
        var_by_res = [
            TheseusVariances(
                idx=0, resName='GLN', resSeq=1, variance=55.757579, stdDev=7.4671, rmsd=18.603266, core=True
            ),
            TheseusVariances(
                idx=1, resName='PRO', resSeq=2, variance=46.981224, stdDev=6.854285, rmsd=17.076522, core=True
            ),
            TheseusVariances(
                idx=2, resName='ARG', resSeq=3, variance=47.734219, stdDev=6.908996, rmsd=17.212826, core=True
            ),
            TheseusVariances(
                idx=3, resName='ARG', resSeq=4, variance=39.857312, stdDev=6.313265, rmsd=15.728643, core=True
            ),
            TheseusVariances(
                idx=4, resName='LYS', resSeq=5, variance=35.477419, stdDev=5.956292, rmsd=14.839295, core=True
            ),
            TheseusVariances(
                idx=5, resName='LEU', resSeq=6, variance=26.066709, stdDev=5.105557, rmsd=12.719802, core=True
            ),
            TheseusVariances(
                idx=6, resName='CYS', resSeq=7, variance=24.114483, stdDev=4.91065, rmsd=12.234218, core=True
            ),
            TheseusVariances(
                idx=7, resName='ILE', resSeq=8, variance=24.610979, stdDev=4.960945, rmsd=12.359523, core=True
            ),
            TheseusVariances(
                idx=8, resName='LEU', resSeq=9, variance=21.187131, stdDev=4.602948, rmsd=11.467621, core=True
            ),
            TheseusVariances(
                idx=9, resName='HIS', resSeq=10, variance=21.882362, stdDev=4.677859, rmsd=11.654251, core=True
            ),
            TheseusVariances(
                idx=10, resName='ARG', resSeq=11, variance=21.62225, stdDev=4.649973, rmsd=11.584778, core=True
            ),
            TheseusVariances(
                idx=11, resName='ASN', resSeq=12, variance=18.680585, stdDev=4.322104, rmsd=10.767937, core=True
            ),
            TheseusVariances(
                idx=12, resName='PRO', resSeq=13, variance=16.568056, stdDev=4.070388, rmsd=10.140819, core=True
            ),
            TheseusVariances(
                idx=13, resName='GLY', resSeq=14, variance=14.889562, stdDev=3.858699, rmsd=9.613426, core=True
            ),
            TheseusVariances(
                idx=14, resName='ARG', resSeq=15, variance=13.889743, stdDev=3.726895, rmsd=9.285052, core=True
            ),
            TheseusVariances(
                idx=15, resName='CYS', resSeq=16, variance=8.722879, stdDev=2.953452, rmsd=7.358125, core=True
            ),
            TheseusVariances(
                idx=16, resName='TYR', resSeq=17, variance=8.719477, stdDev=2.952876, rmsd=7.35669, core=True
            ),
            TheseusVariances(
                idx=17, resName='ASP', resSeq=18, variance=4.648089, stdDev=2.155943, rmsd=5.371239, core=True
            ),
            TheseusVariances(
                idx=18, resName='LYS', resSeq=19, variance=4.263944, stdDev=2.064932, rmsd=5.144498, core=True
            ),
            TheseusVariances(
                idx=19, resName='ILE', resSeq=20, variance=2.338536, stdDev=1.529227, rmsd=3.809862, core=True
            ),
        ]

        # Test Case 1
        ref_tlevels = [100, 95, 90, 85, 80, 75, 70, 65, 60, 55, 50, 45, 40, 35, 30, 25, 20, 15]
        ref_tvariances = [
            55.757579,
            47.734219,
            46.981224,
        ...
        tlevels, tvariances, tresidues, _ = truncation_util.calculate_residues_by_percent(
            var_by_res, percent_truncation=5
        )
        self.assertEqual(ref_tlevels, tlevels)
        ...
        ref_tvariances = [55.757579, 39.857312, 24.610979, 21.62225, 16.568056, 8.722879]
        tlevels, tvariances, tresidues, _ = truncation_util.calculate_residues_by_percent(
            var_by_res, percent_truncation=15
        )
        self.assertEqual(ref_tlevels, tlevels)
        self.assertEqual(ref_tresidues, tresidues)
        self.assertEqual(ref_tvariances, tvariances)
        ...
        tlevels, tvariances, tresidues, _ = truncation_util.calculate_residues_by_percent(
            var_by_res, percent_truncation=50
        )
        self.assertEqual(ref_tlevels, tlevels)
        self.assertEqual(ref_tresidues, tresidues)
        self.assertEqual(ref_tvariances, tvariances)
    ...
    def test_residuesPercentIntervals(self):
        ...
        self.assertRaises(
            RuntimeError,
            truncation_util.calculate_residues_by_percent,
            var_by_res,
    ...
    def test_truncator(self):
        ...
        truncations = truncator.truncate_models(
            models=models, truncation_method=truncation_method, percent_truncation='50'
        )
