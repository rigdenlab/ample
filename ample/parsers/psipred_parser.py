...
class PsipredSs2Parser(object):
    ...
    def checkContent(self):
        """Check the secondary structure composition"""
        warnings.warn(DeprecationWarning, "This function will be removed in a future release - use check_content() instead")
        return self.check_content()
    
    def getSecondaryStructure(self):
        """Get the secondary structure content"""
        warnings.warn(DeprecationWarning, "This function will be removed in a future release - use attribute secondary_structure instead")
