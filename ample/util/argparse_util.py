...
def add_ensembler_options(parser=None):
    ...
    ensembler_group.add_argument('-percent_fixed_intervals', type=list, help='list of integer percentage intervals for truncation')
    ...
    ensembler_group.add_argument('-truncation_method', help='How to truncate the models for ensembling percent|percent_fixed_intevals|focussed|scores')
