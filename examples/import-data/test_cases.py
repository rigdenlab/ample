...
class AMPLETest(AMPLEBaseTest):
    def test_import_models(self):
        ...
        # was 72 changed 19/10/17 with CCP4 7.0.44 linux
        # was 69 changed 10/5/18 with CCP4 7.0.55 linux
        ...
        for i in xrange(1, 4):
            ...
            # switch = {1: (6, 25), 2: (4, 22), 3: (3, 23)} # changed 19/10/17 with CCP4 7.0.44 linux
            switch = {1: (6, 25), 2: (4, 22), 3: (3, 22)} # changed 10/5/18 with CCP4 7.0.55 linux
...
class AMPLETest(AMPLEBaseTest):
    def test_import_cluster(self):
        self.assertTrue(self.AMPLE_DICT['AMPLE_finished'])
        self.assertIn('ensembles', self.AMPLE_DICT)
        self.assertEqual(156, len(self.AMPLE_DICT['ensembles_data']))
        return
