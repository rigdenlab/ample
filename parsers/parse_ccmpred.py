...
class Test(unittest.TestCase):
    def testFilter(self):
        contacts_duplicated = [{'res1_index': 11, 'res2_index': 100, 'confidence_score': 0.5},
                               {'res1_index': 100, 'res2_index': 11, 'confidence_score': 0.5},
                               
                               {'res1_index': 20, 'res2_index': 150, 'confidence_score': 0.3},
                               {'res1_index': 150, 'res2_index': 20, 'confidence_score': 0.3},
                               
                               {'res1_index': 6, 'res2_index': 70, 'confidence_score': 0.2},
                               {'res1_index': 70, 'res2_index': 6, 'confidence_score': 0.9},
                               
                               {'res1_index': 1, 'res2_index': 8, 'confidence_score': 0.2},
                               {'res1_index': 2, 'res2_index': 9, 'confidence_score': 0.2},
                               
                               {'res1_index': 50, 'res2_index': 80, 'confidence_score': 0.5},
                               
                               {'res1_index': 1, 'res2_index': 1, 'confidence_score': -0.000000}]
        
        ref_contacts = [{'res1_index': 11, 'res2_index': 100, 'confidence_score': 0.5},
                        {'res1_index': 20, 'res2_index': 150, 'confidence_score': 0.3},
                        {'res1_index': 6, 'res2_index': 70, 'confidence_score': 0.2},
                        {'res1_index': 1, 'res2_index': 8, 'confidence_score': 0.2},
                        {'res1_index': 2, 'res2_index': 9, 'confidence_score': 0.2},
