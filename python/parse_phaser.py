...
class TestParsers(unittest.TestCase):
    ...
    def testPdbParser1(self):
        ...
        pdb = os.path.join(self.testfiles_dir,"phaser_loc0_ALL_SCWRL_reliable_sidechains_trunc_0.005734_rad_1_UNMOD.1.pdb")
    ...
    def testPdbParser2(self):
        ...
        pdb = os.path.join(self.testfiles_dir,"phaser_loc0_ALL_All_atom_trunc_0.039428_rad_1_UNMOD.1.pdb")
    ...
    def testLogParser1(self):
        ...
        log = os.path.join(self.testfiles_dir,"phaser_loc0_ALL_SCWRL_reliable_sidechains_trunc_0.005734_rad_1_UNMOD.log")
    ...
    def testLogParser2(self):
        ...
        log = os.path.join(self.testfiles_dir,"phaser_loc0_ALL_All_atom_trunc_0.039428_rad_1_UNMOD.log")
